...
function LoginForm({ errorMessage }) {
  ...
  return (
    ...
    >
      <span className="self-center text-3xl font-bold mt-4 mb-8">Login In</span>
      {error && (
      ...
      <button className="w-32 rounded-2xl px-4 py-2 self-center mb-6 shadow-[0_1px_2px_1px_rgba(0,0,0,0.15)]">
        Login
      </button>

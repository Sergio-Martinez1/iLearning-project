...
function Collection({
  ...
  return (
    <section className="w-fit">
      <div className="flex flex-col mb-4 bg-[var(--element-color)] rounded-2xl max-w-96 px-4 py-4">
        <div className="flex gap-x-4 items-center font-bold text-xl flex-wrap">
          <span className="text-2xl">{collection.name}</span>
        ...
        <div className="flex flex-col w-full h-full">
          ...
          <form onSubmit={editCollection} className="flex flex-col">
            ...
            <div className="flex flex-col">
              ...
              {collection.thumbnail_url && (
                <img className="mb-4" src={collection.thumbnail_url} />
              )}
